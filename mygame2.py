...
class AlienInvasion2:
    """Overal class to manage the game assets and behavior."""
    ...
    def _create_fleet(self):
        ...
        available_space_x = self.settings.screen_width - 5 * rocket_width
        ...
        total_aliens = number_rows * number_aliens_x

        # Remove some aliens from the left side.
        aliens_to_remove = total_aliens - self.settings.num_aliens
        number_aliens_x -= aliens_to_remove // number_rows
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        alien.x = self.settings.screen_width - (2 * alien_width) - (2 * alien_width * alien_number)
    ...
    def _update_bullets(self):
        ...
        for bullet in self.bullets.copy():
            if bullet.rect.bottom > self.screen_rect.right:
    ...
    def _save_high_score(self):
        """Save high score before closing the game or start a new game"""
